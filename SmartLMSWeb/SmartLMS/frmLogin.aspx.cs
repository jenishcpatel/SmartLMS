    ...
    public partial class frmLogin : System.Web.UI.Page
    {
        ...
        protected void btnlofin_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                DataSet ds = null;
                ds = new DataSet();
                objlogin.EmpId = txtUserName.Text;
                ...
                if (ds.Tables[0].Rows.Count > 0)
                {
                    ...
                    {
                        if ((ds.Tables[0].Rows[0]["employee_id"].ToString() == txtUserName.Text || ds.Tables[0].Rows[0]["email"].ToString() == txtUserName.Text) && (ds.Tables[0].Rows[0]["PASSWORD"].ToString() == txtPassword.Text.ToString()))
                        {
