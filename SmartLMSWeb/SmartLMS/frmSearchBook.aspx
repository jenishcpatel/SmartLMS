<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmSearchBook.aspx.cs"
    Inherits="SmartLMSWeb.SmartLMS.frmSearchBook" %>
                                                                            ...
                                                                            <tr>
                                                                                <td align="left" valign="top" class="boxgraybg" style="height: 100%;">
                                                                                    ...
                                                                                    <table width="100%">
                                                                                        <tr>
                                                                                            <td align="right">
                                                                                               <asp:Label ID="lblBookName" runat="server" Font-Size="14px" ForeColor="#848484"  Text=" Enter Barcode No / Book Name:"  ></asp:Label>
                                                                                            </td>
                                                                                            ...
                                                                                            <td align="left" style="width: 32%">
                                                                                                <asp:ImageButton ID="btnBook" runat="server" BorderWidth="0" ImageUrl="~/IMAGES/1453648662_button_45.png"
                                                                                                    Height="31px" Width="34px" ToolTip="Search Book " OnClick="btnBook_Click" />
                                                                                            </td>
                                                                                        </tr>
                                                                                    </table>
                                                                                    <table width="100%">
                                                                                            ...
                                                                                            <td style="width: 100%;" align="center">
                                                                                                <asp:GridView ID="gvBookList" runat="server" AutoGenerateColumns="False" Width="100%"
                                                                                                    ...
                                                                                                    <Columns>
                                                                                                        ...
                                                                                                        <asp:BoundField HeaderText="Books Remaining" DataField="REMAINIGBOOKS">
                                                                                                            <ItemStyle HorizontalAlign="Center" />
                                                                                                        </asp:BoundField>
