<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmAddDesignation.aspx.cs" Inherits="SmartLMSWeb.SmartLMS.frmAddDesignation" %>
                                                                            ...
                                                                            <td align="left" valign="top" class="boxgraybg" style="height: 100%;">
                                                                                <table width="100%">
                                                                                    <tr style="background-color: #313D53;">
                                                                                        <td>
                                                                                            <asp:Label ID="lblDisplay" runat="server" Text="Designation Name" ForeColor="White"></asp:Label>
                                                                                        </td>
                                                                                    </tr>
                                                                                </table>
                                                                                <table width="100%">
                                                                                    <tr>
                                                                                        <td style="width: 50%" align="right">
                                                                                            <asp:Label ID="lblDep" runat="server" Text="Designation Name:" Font-Size="14px" ForeColor="#848484"></asp:Label>
                                                                                        </td>
                                                                                        <td style="width: 50%" colspan="5">
                                                                                            <asp:TextBox ID="txtDesignation" runat="server" Height="30px" Width="130px"></asp:TextBox>
                                                                                        </td>
                                                                                    </tr>
                                                                                </table>
                                                                                <br />
                                                                                    ...
                                                                                    <tr>
                                                                                        <td style="width: 100%;" align="center">
                                                                                            <asp:GridView ID="gvDisplay" runat="server" AutoGenerateColumns="False" Width="100%"
                                                                                                ...
                                                                                                DataKeyNames="DESIG_ID,DESIG_NAME" OnRowCommand="gvDisplay_RowCommand" 
                                                                                                onpageindexchanging="gvDisplay_PageIndexChanging">
                                                                                                <Columns>
                                                                                                    <asp:BoundField HeaderText="Designation Name" DataField="DESIG_NAME">
                                                                                                        <ItemStyle HorizontalAlign="Center" />
                                                                                                    </asp:BoundField>
                                                                                                    <asp:BoundField HeaderText="DesID" DataField="DESIG_ID" Visible="false">
                                                                                                        <ItemStyle HorizontalAlign="Center" />
                                                                                                    </asp:BoundField>
