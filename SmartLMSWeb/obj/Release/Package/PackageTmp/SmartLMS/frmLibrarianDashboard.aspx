<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmLibrarianDashboard.aspx.cs"
    Inherits="SmartLMSWeb.SmartLMS.frmLibrarianDashboard" %>
                            ...
                            <table width="100%">
                                <tr>
                                    <td style="width: 100%;" align="center">
                                        <asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="~/IMAGES/OnlineApplication.png"
                ...
                <tr>
                    <td style="width: 33%;">
                        <table width="100%">
                            <tr>
                                <td style="width: 100%;" align="center">
                                    <asp:ImageButton ID="ImageButton7" runat="server" Height="48px" ImageUrl="~/IMAGES/1453160287_checked-checklist-notepad.png"
                                        Width="67px" onclick="ImageButton7_Click" />
                                    <br />
                                    Daily Reports
                                </td>
                            </tr>
