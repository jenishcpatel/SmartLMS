<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmTransactions.aspx.cs"
    Inherits="SmartLMSWeb.SmartLMS.frmTransactions" %>
                                                                                            ...
                                                                                            <tr>
                                                                                                <td style="width: 100%;" align="center">
                                                                                                    <asp:GridView ID="gvAlredayIssued" runat="server" AutoGenerateColumns="False" Width="100%" Font-Size="14px"
                                                                                                        DataKeyNames="ISSUED_ID,created_on,isue_to_date,EXTEND_TIME,EXTEND_DAYS,bar_code"
                                                                                    ...
                                                                                    <table width="100%">
                                                                                        <tr>
                                                                                            ...
                                                                                            <td style="width: 25%">
                                                                                                ...
                                                                                                &nbsp;
                                                                                                <input id="Button1" class="buttonRann" name="but_tio_dtd" style="width: 20px" type="button"
                                                                                                    value="..." />
                                                                                            </td>
                                                                                            <td style="width: 20%" align="right">
